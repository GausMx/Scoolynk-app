...
const mockSaveSettings = async (section, payload) => {
    ...
    return { message: `${section === 'security' ? 'Password changed' : section + ' settings updated'} successfully!`, status: 200 };
};
...
const Settings = () => {
    ...
    const renderProfileSection = () => (
        <form onSubmit={(e) => { e.preventDefault(); handleSave('profile'); }}>
            <div className="mb-4">{renderField('schoolName', profile.schoolName, setProfile)}
        ...
        <form onSubmit={(e) => { e.preventDefault(); handleSave('academic'); }}>
            ...
            <div className="row mb-3 border-top pt-3">
                ...
                <div className="col-12 col-md-8">
                    ...
                    <small className="text-warning">{editMode && "Note: Classes and Subjects require a complex editor and are only displayed here."}</small>
                </div>
            </div>
