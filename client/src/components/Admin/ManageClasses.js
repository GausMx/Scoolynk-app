    ...
    const DeleteConfirmation = ({ cls, onConfirm, onCancel, isDeleting }) => (
        <>
            <div className="alert alert-warning border-warning rounded-3 mb-4 d-flex align-items-center">
                ...
                <div>
                    Are you sure you want to delete the class: <strong>{cls.name}</strong>? This action cannot be undone.
                </div>
            </div>
            <div className="d-flex justify-content-end">
                ...
                <div className="row mb-4">
                    <div className="col-12 col-md-4">
                        <div className="input-group">
                            ...
                            <input type="text" className="form-control rounded-end-3 border-start-0 ps-0" placeholder="Search classes..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
                        </div>
                    </div>
                </div>
